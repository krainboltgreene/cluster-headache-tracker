defmodule CoreWeb.AccountSettingsLive do
  ...
  def mount(%{"token" => token}, _session, socket) do
    socket =
      case Users.update_account_email(socket.assigns.current_account, token) do
        :ok ->
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      ...
      |> assign(:email_changeset, Users.change_account_email(account))
      |> assign(:password_changeset, Users.change_account_password(account))
  ...
  def handle_event("validate_email", params, socket) do
    ...
    email_changeset = Users.change_account_email(socket.assigns.current_account, account_params)
  ...
  def handle_event("update_email", params, socket) do
    ...
    case Users.apply_account_email(account, password, account_params) do
      {:ok, applied_account} ->
  ...
  def handle_event("validate_password", params, socket) do
    ...
    password_changeset =
      Users.change_account_password(socket.assigns.current_account, account_params)
  ...
  def handle_event("update_password", params, socket) do
    ...
    case Users.update_account_password(account, password, account_params) do
      {:ok, account} ->
        socket =
          socket
          |> assign(:trigger_submit, true)
          |> assign(:password_changeset, Users.change_account_password(account, account_params))
